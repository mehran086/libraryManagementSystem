...
//
//        // Load existing data
//        if(booksFile!=null) FileUtil.loadBooks(booksFile).forEach(bookrepo::save);
//        if(usersFile!=null) FileUtil.loadUsers(usersFile).forEach(userRepo::save);
//        if(borrowedFile!=null) trackBooks.putAll(FileUtil.loadBorrowedBooks(borrowedFile));
//    }
//
//    // ---------------- Librarian Functions ----------------
//
...
public class LibraryService {
    ...
    public LibraryService(BookRepository bookrepo, UserRepository userRepo,
        ...
        // Load existing data (only if files provided)
        if (booksFile != null) {
